...
export default function Patient() {
  ...
  const handleToggleStatus = async (patientId, currentStatus, patientName) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/admin/patients/${patientId}/status`, {
        method: 'PUT',
        headers: { 
          'Content-Type': 'application/json', 
          'Authorization': `Bearer ${token}` 
